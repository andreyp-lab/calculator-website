...
// תקרת המשכורת הקובעת לקרן השתלמות לשכיר 2026: 15,712 ₪/חודש.
// תקרת הפקדת המעסיק הפטורה ממס = 15,712 × 7.5% × 12 = 14,140.80 ₪/שנה.
export const STUDY_FUND_MAX_ANNUAL = 14_140.8; // ₪/שנה - תקרת הפקדת מעסיק פטורה ממס (2026)
