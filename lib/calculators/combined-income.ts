 ...
 *    (7,703 ₪) ביחס לשכר — הקובץ אינו מפרט. כאן ההכנסה העצמאית
 *    "יושבת" על השכר גם לעניין מדרגות הב"ל: החלק שמעל השכר ועד 7,703 ₪
 *    בשיעור מופחת (6.1%), והחלק שמעליו ועד התקרה בשיעור מלא (18%).
 *    אם השכר כבר חצה את 7,703 ₪ — כל ההכנסה העצמאית בשיעור המלא.
 *
...
export function calculateSelfEmployedBituachWithSalary(
  ...
  // החלק שמעל השכר ועד 7,703 ₪ — שיעור מופחת; מעליו — שיעור מלא.
