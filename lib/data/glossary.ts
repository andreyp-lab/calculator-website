...
export const ALL_TERMS: GlossaryTerm[] = [
  ...
  },
  {
    ...
    letter: 'ב',
    definition:
      'תשלומי חובה לב.ל. המממן גמלאות: אבטלה, לידה, זקנה, נכות, מחלה. שכיר: 4.27% (מופחת) / 12.17% (מלא). מעסיק: 4.51% / 7.6%. עצמאי: 6.10% (מופחת) / 18% (מלא). הגמלאות שמקבלים תלויות בהכנסה ובוותק.',
    seeAlso: [
  ...
  },
  {
    ...
    letter: 'מ',
    definition:
      'מס ערך מוסף – 18% (2026). גבייה ממצרכים ושירותים. עוסק מורשה גובה ומעביר לרשות המסים, ומזכה תשומות. עוסק פטור: מחזור עד 122,833 ₪, לא גובה ולא מזוכה.',
    seeAlso: [
  ...
  // ע
  {
    ...
    letter: 'ע',
    definition:
      'עסק קטן עם מחזור עד 122,833 ₪/שנה. פטור מגביית מע"מ ומדיווח מע"מ חודשי. החיסרון: לא יכול להחזיר מע"מ על הוצאות, ולקוחות עסקיים לא יכולים לנכות מע"מ ממנו.',
    seeAlso: [
      { label: 'מחשבון מע"מ', href: '/self-employed/vat' },
      { label: 'מדריך מסים', href: '/guides/taxes-complete-guide-2026' },
    ],
  },
  {
    ...
    letter: 'ע',
    definition:
      'עסק שמחזורו מעל 122,833 ₪/שנה (חובה), או עוסק שבחר להירשם גם מתחת לסף. גובה 18% מע"מ, מגיש דיווח דו-חודשי/חודשי. מקבל החזר מע"מ על הוצאות.',
  ...
  // פ
  {
    ...
    letter: 'פ',
    definition:
      'שכר אחרון × שנות ותק. מגיע לאחר שנת עבודה ראשונה. עמ זכאי: פיטורים, התפטרות בדין מפוטר, פרישה לגמלאות. פטור ממס: 13,750 ₪ לשנת ותק (2026).',
    seeAlso: [
      { label: 'מחשבון פיצויים', href: '/employee-rights/severance' },
