...
export const allCalculators: CalculatorEntry[] = [
  ...
  },
  {
    ...
    category: 'מיסוי אישי',
    categoryHref: '/personal-tax',
    description: 'השוואת שכר vs קצבה - שווי אמיתי של עבודה',
    icon: '⚖️',
    keywords: ['שווי עבודה', 'מה שווה לעבוד', 'שעת עבודה', 'דמי לידה', 'מעון', 'הוצאות עבודה'],
  },
  // נדל"ן
  {
  ...
  },
  {
    ...
    category: 'זכויות עובדים',
    categoryHref: '/employee-rights',
    description: 'גובה דמי אבטלה ותקופת זכאות',
    icon: '💼',
    keywords: ['דמי אבטלה', 'אבטלה', 'פיטורים', 'מחפש עבודה', 'unemployed'],
  },
  {
    id: 'reserve-duty-pay',
  ...
  // השקעות
  {
    ...
    description: 'פרישה מוקדמת - תוך כמה שנים תוכל לפרוש',
    icon: '🔥',
    keywords: ['FIRE', 'פרישה מוקדמת', 'עצמאות כלכלית', '4% rule', 'Financial Independence'],
  },
  // השוואות
  {
    id: 'compare-employee-self-employed',
    title: 'שכיר vs עצמאי - השוואה',
    href: '/compare/employee-vs-self-employed',
    category: 'דפי השוואה',
    categoryHref: '/compare',
    description: 'איזה מסלול תעסוקה משתלם יותר',
    icon: '⚖️',
    keywords: ['שכיר', 'עצמאי', 'השוואה', 'מסלול תעסוקה', 'מס'],
  },
  {
    id: 'compare-rent-buy',
    ...
    category: 'דפי השוואה',
    categoryHref: '/compare',
    description: 'דירה - לקנות או לשכור?',
    icon: '🏠',
    keywords: ['שכירות', 'קנייה', 'דירה', 'משכנתא', 'rent vs buy'],
  },
  {
    ...
    icon: '🚗',
    keywords: ['ליסינג', 'רכב', 'קנייה', 'מימון', 'רכב חברה'],
  },
  ...
  },
  {
    ...
    category: 'כלים לבעלי עסקים',
    categoryHref: '/tools',
    description: 'כמה צריך למכור כדי לכסות הוצאות',
    icon: '⚖️',
    keywords: ['נקודת איזון', 'break-even', 'איזון', 'תרומה ליחידה', 'הוצאות קבועות'],
  },
  {
  ...
  },
  {
    ...
    title: 'מחשבון CLV / LTV',
    href: '/tools/customer-lifetime-value',
    category: 'כלים לבעלי עסקים',
    categoryHref: '/tools',
    description: 'שווי לקוח לטווח ארוך - LTV/CAC, Payback',
    icon: '👤',
    keywords: ['CLV', 'LTV', 'שווי לקוח', 'CAC', 'Churn', 'SaaS', 'subscription', 'unit economics'],
  },
  {
    id: 'allowed-expenses',
  ...
  },
  {
    ...
    category: 'עצמאיים',
    categoryHref: '/self-employed',
    description: 'בדוק אם חצית את תקרת 122,833 ₪ ומה לעשות במעבר לעוסק מורשה',
    icon: '📊',
    keywords: [
      'עוסק פטור',
      'תקרת עוסק פטור',
  ...
  },
  {
    ...
    category: 'עצמאיים',
    categoryHref: '/self-employed',
    description: 'אופטימיזציית מס לבעל חברה - מיקס אופטימלי',
    icon: '💸',
    keywords: ['דיבידנד', 'משכורת', 'בעל מניות', 'מס דיב', 'בעל חברה', 'משיכה', 'אופטימיזציה'],
  },
];
