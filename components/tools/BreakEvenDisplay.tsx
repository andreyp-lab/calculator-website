    ...
    <div className="space-y-4">
      ...
      <div className="bg-paper border-2 border-ink/15 shadow-sm overflow-hidden">
        <div className="bg-ink text-cream p-4">
          ...
          <p className="text-xs text-cream/70">Break-Even + מרווח בטחון + מינוף תפעולי</p>
        </div>
      </div>

      {/* Main Status */}
      <div
        className={`bg-${safetyColor}-50 border-4 border-${safetyColor}-300 p-6 text-center`}
      >
