    ...
    <div className="bg-paper border-2 border-ink/15 p-5 shadow-sm">
      <div className="flex items-center justify-between mb-4">
        ...
        <button
          ...
          className="flex items-center gap-1 px-3 py-1.5 bg-green-600 text-white rounded-none hover:bg-green-700 text-sm"
        >
      ...
      {showForm && (
        <div className="bg-cream-2 border border-ink/15 rounded-none p-4 mb-4">
          ...
          {/* === הוצאה משתנה מקושרת === */}
          <div className="mt-4 p-3 bg-paper border-2 border-ink/15 rounded-none">
            ...
            {varExp.enabled && (
              <div className="grid grid-cols-2 md:grid-cols-3 gap-2 pt-2 border-t border-ink/10">
                ...
                <div>
                  <label className="block text-xs text-ink/70 mb-1">תנאי תשלום</label>
                  <select
                ...
                <div className="col-span-2 md:col-span-3 text-xs text-ink bg-cream-2 p-2 rounded-none">
          ...
          <div className="flex gap-2 mt-3">
            <button
              ...
              className="px-4 py-2 bg-green-600 text-white rounded-none hover:bg-green-700 disabled:opacity-50"
            >
              הוסף
            </button>
            <button
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              {budget.income.map((inc) => {
                ...
                return (
                  <tr key={inc.id} className="border-b border-ink/10 hover:bg-cream-2">
