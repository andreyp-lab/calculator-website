  ...
  return (
    <div className="grid lg:grid-cols-5 gap-6">
      <div className="lg:col-span-3 bg-paper border border-ink/15 rounded-none p-6">
        <h2 className="text-xl font-bold text-ink mb-6">נתוני העסק</h2>
      ...
      <div className="lg:col-span-2 space-y-4">
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-none p-3 text-xs text-amber-900">
