            ...
            <>
              ...
              <div className="bg-emerald-50 border border-emerald-200 rounded-none p-4 text-sm space-y-2">
                ...
                <ul className="space-y-1 text-emerald-800 text-xs">
                  ...
                  <li>• נדרש: ת.ז. ואסמכתת חשבון בנק (ללא טופס 106)</li>
                  <li>• הגשה מקוונת כל השנה, אחרי תום שנת המס</li>
                  <li>• החלטה: עד 90 ימים מתביעה מלאה</li>
                  <li>• ניתן להגיש עד שנתיים מתום שנת המס</li>
                </ul>
              </div>
            </>
          ) : (
  ...
  return (
    <div className="space-y-4">
        ...
        {result.isEligible && (
          <div className="mt-4 p-4 bg-emerald-50 border border-emerald-200 rounded-none">
            ...
            <p className="text-xs text-emerald-800 mt-1">
              ניתן להגיש עד שנתיים אחורה — ב-2026: שנות המס 2024 ו-2025
            </p>
          </div>
        )}
      </div>
      ...
      <InfoBox variant="blue">
        ...
        <p className="text-sm">
          הגשה לשנת מס 2025 פתוחה באתר רשות המסים — מומלץ להגיש עד <strong>30.6.2026</strong>{' '}
          (התשלום הראשון ב-15.7.2026). ניתן להגיש עד שנתיים מתום שנת המס; ב-2026 פתוחות גם
          שנת 2024 (עד סוף דצמבר 2026) וגם 2025.
        </p>
      </InfoBox>
    </div>
  );
