            ...
            <div className="h-72">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={stackedChartData}>
                  ...
                  />
                  <Legend wrapperStyle={{ fontSize: 12 }} />
                  <Bar dataKey="הפקדות" stackId="a" fill="#264B36" />
                ...
                <tbody>
                  {scenarioResults.map((s, i) => (
                    <tr key={i} className={i % 2 === 0 ? 'bg-paper' : 'bg-cream-2'}>
                      ...
                      <td className="p-2 border border-ink/15 tabular-nums font-medium">
            ...
            <table className="w-full text-sm border-collapse min-w-[600px]">
              <thead>
                <tr className="bg-cream-2">
                  ...
                  <th className="text-right p-2 border border-ink/15">ריבית שנצברה</th>
              ...
              <tbody>
                {tableRows.map((row, i) => {
                  ...
                  return (
                    <tr
                      key={row.year}
                      className={`${i % 2 === 0 ? 'bg-paper' : 'bg-cream-2'} ${isCrossover ? 'ring-2 ring-inset ring-emerald-400' : ''}`}
                    >
                      ...
                      <td className="p-2 border border-ink/15 tabular-nums font-bold">
  ...
  return (
    <>
      ...
      <div className="bg-paper border border-ink/15 rounded-none p-4 space-y-2 text-sm">
        <h4 className="font-bold text-ink mb-3">📊 פירוט</h4>
  ...
  return (
    <>
      <div className="bg-ink border-2 border-ink rounded-none p-5 text-cream">
        <p className="text-sm font-medium text-cream/80 mb-1">🎯 הפקדה חודשית נדרשת</p>
        <p className="text-4xl font-bold text-cream tabular-nums mb-1">
      ...
      <div className="bg-paper border border-ink/15 rounded-none p-4 space-y-2 text-sm">
        <h4 className="font-bold text-ink mb-3">📊 פירוט יעד</h4>
...
function EducationalExamples({ input }: { input: CompoundInterestInput }) {
  ...
  return (
    <div className="bg-cream-2 border border-ink/15 rounded-none p-5">
      <h3 className="font-bold text-ink text-lg mb-4">📚 תרחישי לימוד — כוח ריבית דריבית</h3>
      ...
      <div className="grid md:grid-cols-3 gap-4">
        ...
        <div className="bg-paper rounded-none border border-ink/15 p-4">
          ...
          <div className="space-y-2 text-sm">
            ...
            <div className="flex justify-between">
              <span className="text-ink/70">התחיל בגיל 35 (30 שנה):</span>
        ...
        {/* דוגמה 2: Rule of 72 */}
        <div className="bg-paper rounded-none border border-ink/15 p-4">
          <h4 className="font-bold text-ink mb-2">✕2 כלל 72</h4>
          <p className="text-xs text-ink/70 mb-3">
        ...
        <div className="bg-paper rounded-none border border-ink/15 p-4">
          <h4 className="font-bold text-ink mb-2">📈 ריבית משנה הכל</h4>
          <p className="text-xs text-ink/70 mb-3">
