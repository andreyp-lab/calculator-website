  ...
  return (
    <>
      <CalculatorLayout
        ...
        pageUrl="/tools/business-valuation"
        calculator={<BusinessValuationCalculator />}
        quickAnswer={
          <p className="text-lg text-ink leading-relaxed">
            <strong>
              שווי של עסק נאמד בשלוש שיטות עיקריות, ובפועל מקובל להריץ את שלושתן ולהשוות את
              הטווח שהתקבל — לא להסתמך על אחת בלבד.
            </strong>{' '}
            <strong>מכפיל EBITDA</strong> היא השיטה הנפוצה בעסקאות מיזוג ורכישה: מכפילים את הרווח
            התפעולי לפני פחת והפחתות במכפיל ענפי, כך שעסק שירותים עם EBITDA של מיליון ₪ ומכפיל
            4 נאמד בכ-4 מיליון ₪. <strong>DCF</strong> (היוון תזרים מזומנים) מהוון את התזרימים
            העתידיים לערך נוכחי לפי שיעור היוון — מדויקת תיאורטית אך רגישה מאוד להנחות, וסטייה
            של אחוז אחד בשיעור ההיוון יכולה לשנות את התוצאה ב-10%–15%. <strong>מכפיל הכנסות</strong>{' '}
            מתאים לעסקים צעירים שטרם הגיעו לרווחיות, ובעיקר ל-SaaS, אך מתעלם לחלוטין מרווחיות.
            המכפיל בפועל תלוי בענף, בקצב הצמיחה ובמידת התלות של העסק בבעליו. המחשבון שמתחת מריץ
            את שלוש השיטות ומציג את טווח השווי המתקבל.
          </p>
        }
        content={
          <>
