    ...
    <CalculatorLayout
      ...
      quickAnswer={
        <p className="text-lg text-ink leading-relaxed">
          דמי אבטלה ב-2026 משולמים לשכיר בגיל 20 עד 66 שצבר לפחות 12 חודשי ביטוח ב-18
          החודשים האחרונים ונרשם כמחפש עבודה בשירות התעסוקה. הסכום היומי מחושב מהשכר
          בשיעורים מדורגים: 80% על שכר עד 60% מהשכר הממוצע, 60% על החלק שבין 60% ל-80%,
          ו-50% מעל — עד תקרה יומית של 550.76 ₪ ב-125 הימים הראשונים ו-367.17 ₪ מהיום
          ה-126 ואילך. תקופת הזכאות נעה בין 50 ל-175 ימים לפי גיל ומצב משפחתי. אחרי
          פיטורים חלה המתנה של 5 ימים בלבד, ואחרי התפטרות רגילה — 90 יום. המחשבון שמתחת
          מחשב את הסכום המלא לפי הנתונים שלכם.
        </p>
      }
