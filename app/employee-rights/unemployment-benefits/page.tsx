    ...
    <CalculatorLayout
      ...
      content={
        <>
          ...
          <h2>מה שאין במחשבוני האבטלה האחרים</h2>
          <p>
            רוב המחשבונים ברשת מראים רק "כמה ליום" — בלי כל הגורמים שבאמת קובעים את הסכום
            שתקבל. המחשבון הזה לוקח בחשבון את כל המשתנים:
          </p>
          <ul>
            <li>
              <strong>תקופת זכאות לפי גיל ומצב משפחתי:</strong> מ-50 ימים ועד 175 ימים — לא
              רק "כמה ליום" אלא <em>לכמה זמן</em>, וזה ההבדל בין כמה אלפי שקלים לעשרות אלפים.
            </li>
            <li>
              <strong>הירידה ביום ה-126:</strong> התקרה היומית צונחת מ-550.76 ₪ ל-367.17 ₪.
              מחשבונים שמתעלמים מזה מנפחים את הסכום הכולל — כאן זה מחושב נכון.
            </li>
            <li>
              <strong>עבודה חלקית והשפעת מס:</strong> כולל את סף ה-50% מהשכר הממוצע שמפסיק
              את התשלום, ואת ניכוי המס האוטומטי — כדי שתראה מספר נטו אמיתי.
            </li>
          </ul>
