...
export const metadata: Metadata = {
  ...
  description: `בדוק תוך 30 שניות אם מגיע לך מענק עבודה 2026: הכנסה ${MIN_INCOME}–${MAX_PARENT} ₪, גיל ${WORK_GRANT_MIN_AGE_WITH_CHILDREN}/${WORK_GRANT_MIN_AGE_NO_CHILDREN}+ וּותק עבודה. בדיקת זכאות חינם, כולל ${6} שנים אחורה.`,
...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      'כן, ניתן להגיש עד 6 שנים אחורה. ב-2026 זה אומר שנות המס 2020 עד 2025. בדיקת זכאות לשנים קודמות משתמשת בסכומים של אותה שנה, אבל תנאי הזכאות עצמם דומים. מענק מצטבר על מספר שנים יכול להגיע לעשרות אלפי שקלים.',
  },
  {
    question: 'הבדיקה מראה שאני זכאי. מה עכשיו?',
    answer:
      'הגשה נעשית באתר רשות המסים, בחלון אוגוסט–ספטמבר לשנת המס הנוכחית (ולשנים קודמות — בכל עת). נדרשים תעודת זהות, טופס 106 מהמעסיק או הדוח השנתי לעצמאי, ופרטי חשבון בנק. העיבוד אורך עד 90 יום, והכסף מועבר ישירות לחשבון.',
  },
  {
...
const howToSteps = [
  ...
  },
  {
    ...
    text: 'אם נמצאת זכאי, הגש באתר רשות המסים עם תעודת זהות, טופס 106 או הדוח השנתי, ופרטי חשבון בנק. העיבוד אורך עד 90 יום.',
  },
];
      ...
      <CalculatorLayout
        ...
        content={
          <>
            ...
            <ol>
              <li>חלון ההגשה לשנת המס הנוכחית: אוגוסט–ספטמבר. לשנים קודמות — בכל עת.</li>
              <li>הגשה באתר רשות המסים, במסלול &quot;מענק עבודה&quot;.</li>
              <li>מסמכים: תעודת זהות, טופס 106 (שכיר) או דוח שנתי (עצמאי), פרטי חשבון בנק.</li>
              <li>עיבוד: עד 90 יום, תשלום ישירות לחשבון.</li>
              <li>בדוק גם את שנות המס 2020–2025 — ניתן להגיש עד 6 שנים אחורה.</li>
            </ol>
        ...
        sources={
          <ul>
            ...
            <li>
              <a href="https://www.kolzchut.org.il/he/מענק_עבודה" rel="nofollow noopener">
                כל זכות — מענק עבודה
              </a>
            </li>
          </ul>
