          ...
          <div className="space-y-3">
            {[
              ...
              },
              {
                ...
                a: `מסלולי צמוד מדד — הקרן עולה עם המדד. למשל, משכנתא של ₪500,000 צמודת מדד עולה בכ-₪${Math.round(500_000 * annualRate / 100).toLocaleString('he-IL')} בשנה עם אינפלציה של ${annualRate}%.`,
              },
              {
                q: `האם אינפלציה של ${annualRate}% גבוהה?`,
                a: `יעד בנק ישראל הוא 1%-3%. אינפלציה של ${annualRate}% נמצאת בסוף טווח היעד ונחשבת גבוהה מעט אך בשליטה.`,
              },
            ].map(({ q, a }) => (
