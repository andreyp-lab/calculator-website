...
export const metadata = {
  ...
  title: 'אודות — אנדרי פלטונוב, רו״ח וסמנכ״ל כספים',
  description:
    'חשבונאי נבנה על ידי אנדרי פלטונוב — רו״ח מוסמך וסמנכ״ל כספים עם 15+ שנות ניסיון. מחשבונים פיננסיים מדויקים בעברית, מעודכנים לחוק 2026.',
  openGraph: {
