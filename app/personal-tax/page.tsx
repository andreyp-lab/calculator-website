...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      'מהברוטו יורדים שלושה ניכויי חובה: מס הכנסה לפי המדרגות, דמי ביטוח לאומי ודמי ביטוח בריאות (יחד 4.27% על חלק השכר עד 7,522 ₪ בחודש, ו-12.17% מעליו). בנוסף יורדות הפרשות העובד לפנסיה ולעיתים לקרן השתלמות.',
  },
  {
          ...
          <div>
            ...
            <div className="space-y-3 text-ink/75 leading-relaxed">
              <p>
                ...
                ביטוח לאומי ודמי ביטוח בריאות. על חלק השכר עד 7,522 ₪ בחודש שיעור הביטוח
