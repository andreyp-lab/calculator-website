      ...
      <div className="bg-ink text-cream py-16 px-4">
        <div className="max-w-5xl mx-auto">
          <div className="text-sm text-cream/70 mb-3">
            ...
            {' › '}
            <Link href="/real-estate" className="hover:text-cream">נדל&quot;ן</Link>
            {' › '}
      ...
      <div className="max-w-5xl mx-auto px-4 py-10 lg:flex lg:gap-10">
        ...
        <main className="flex-1 min-w-0">
          ...
          <section id="five-questions" className="mb-14 scroll-mt-8">
            ...
            <p className="text-ink/70 mb-6 text-lg">
            ...
            <h3 className="text-xl font-bold text-ink mb-3">שאלה 1: מהי יכולת ההחזר החודשית האמיתית שלך?</h3>
            ...
            <h3 className="text-xl font-bold text-ink mb-3">שאלה 2: כמה הון עצמי יש לך?</h3>
            <p className="text-ink/70 mb-5">
            ...
            <h3 className="text-xl font-bold text-ink mb-3">שאלה 3: מה אורך חיי הצפוי עם הדירה?</h3>
            <p className="text-ink/70 mb-5">
            ...
            <h3 className="text-xl font-bold text-ink mb-3">שאלה 4: מה סיבולת הסיכון שלך?</h3>
            <p className="text-ink/70 mb-5">
            ...
            <h3 className="text-xl font-bold text-ink mb-3">שאלה 5: האם אתה יודע את הרקורד הפיננסי שלך?</h3>
            <p className="text-ink/70 mb-5">
            ...
            <div className="bg-cream-2 border border-ink/15 rounded-none p-5 mt-6">
              <h4 className="font-bold text-ink mb-2">כלי לחישוב ראשוני</h4>
              ...
              <Link
                ...
                className="inline-block bg-ink text-cream px-4 py-2 rounded-none hover:bg-ink-deep text-sm font-medium"
              >
                מחשבון משכנתא בסיסי ←
              </Link>
            </div>
          ...
          <section id="glossary" className="mb-14 scroll-mt-8">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              {[
                ...
                { term: 'פריים (Prime)', def: 'ריבית בנק ישראל + 1.5%. נכון ליוני 2026: ריבית ב"י = 3.75%, פריים = 5.25%. ריבית זו משתנה בכל פעם שבנק ישראל משנה את הריבית הבסיסית.' },
                ...
                <div key={item.term} className="bg-cream-2 rounded-none p-4 border border-ink/15">
                  <dt className="font-bold text-ink mb-1">{item.term}</dt>
                  <dd className="text-ink/70 text-sm">{item.def}</dd>
                </div>
              ))}
            </div>
          ...
          <section id="tldr" className="mb-14 scroll-mt-8">
            ...
            <div className="bg-cream-2 border border-ink/15 rounded-none p-6">
              <ol className="space-y-3 text-ink">
                ...
                <li className="flex gap-3">
                  <span className="font-bold text-gold flex-shrink-0">6.</span>
                  <span><strong>מחזור:</strong> בדוק מחדש כל 3–5 שנים. ירידת ריבית של 1% יכולה לחסוך 100,000 ₪+.</span>
                </li>
                <li className="flex gap-3">
                  <span className="font-bold text-gold flex-shrink-0">7.</span>
          ...
          <section id="when" className="mb-14 scroll-mt-8">
            ...
            <h3 className="text-xl font-bold text-ink mb-3">מחזור ריבית בנק ישראל</h3>
            <p className="text-ink/70 mb-5">
              ריבית בנק ישראל (יוני 2026) היא 3.75% (פריים = 5.25%). הריבית הגבוהה יחסית אומרת שמשכנתא יקרה יותר
              מאשר בתקופת ריבית 0.1% (2021). אולם מחירי הדירות לא ירדו בהתאם, ולמעשה בחלק
              מהאזורים עלו. לכן, ממתינים לא בהכרח נהנים.
            </p>

            <h3 className="text-xl font-bold text-ink mb-3">מדד כדאיות: שכירות vs. משכנתא</h3>
            <p className="text-ink/70 mb-5">
            ...
            <h3 className="text-xl font-bold text-ink mb-3">מתי כן כדאי?</h3>
            ...
            <h3 className="text-xl font-bold text-ink mb-3">מתי לא?</h3>
            <ul className="list-disc list-inside text-ink/70 space-y-2 mb-5">
          ...
          <section id="how-much" className="mb-14 scroll-mt-8">
            ...
            <h3 className="text-xl font-bold text-ink mb-3">LTV – הגבלת אחוז מימון</h3>
            <div className="overflow-x-auto mb-6">
              <table className="w-full border-collapse text-sm">
                <thead>
                  <tr className="bg-ink text-cream">
                    <th className="border border-ink/20 p-3 text-right">סוג רוכש</th>
                    <th className="border border-ink/20 p-3 text-right">LTV מקסימלי</th>
                    <th className="border border-ink/20 p-3 text-right">הון עצמי מינימלי</th>
                    <th className="border border-ink/20 p-3 text-right">דוגמה על 2M₪</th>
                  </tr>
                </thead>
                <tbody>
                  {[
                    ...
                    <tr key={type} className={i % 2 === 0 ? 'bg-paper' : 'bg-cream-2'}>
                      ...
                      <td className="border border-ink/15 p-3 text-green-700 font-bold">{ltv}</td>
                      <td className="border border-ink/15 p-3 text-red-700">{equity}</td>
                      <td className="border border-ink/15 p-3">{example}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
            ...
            <h3 className="text-xl font-bold text-ink mb-3">DTI – יחס חוב להכנסה</h3>
            <p className="text-ink/70 mb-5">
            ...
            <Link
              href="/real-estate/mortgage"
              className="inline-block bg-ink text-cream px-5 py-2.5 rounded-none hover:bg-ink-deep font-medium"
            >
          ...
          <section id="directive-329" className="mb-14 scroll-mt-8">
            ...
            <div className="grid md:grid-cols-3 gap-4 mb-6">
              {[
                ...
                },
                {
                  ...
                  color: 'bg-cream-2 border-ink/30',
                },
              ].map((item) => (
                <div key={item.rule} className={`${item.color} border-r-4 rounded-none p-5`}>
                  <h3 className="font-bold text-ink mb-2">{item.rule}</h3>
            ...
            <div className="mt-4">
              <Link href="/blog/boi-directive-329-mortgage-rules" className="text-gold underline text-sm">
          ...
          <section id="tracks" className="mb-14 scroll-mt-8">
            ...
            <h3 className="text-xl font-bold text-ink mb-3">מסלול 1: פריים (Prime)</h3>
            <p className="text-ink/70 mb-2">
              <strong>מהו:</strong> ריבית הבנק + 1.5%. כיום (יוני 2026): ריבית ב&quot;י 3.75% → פריים 5.25%.
            </p>
            <p className="text-ink/70 mb-2"><strong>יתרון:</strong> ריבית נמוכה בתקופת ריבית ב&quot;י נמוכה. פירעון מוקדם ללא עמלה. גמישות מלאה.</p>
            <p className="text-ink/70 mb-5"><strong>חיסרון:</strong> ריבית עולה כשבנק ישראל מעלה. מגבלת 33% מהתמהיל. חוסר ודאות.</p>

            <h3 className="text-xl font-bold text-ink mb-3">מסלול 2: קל&quot;צ (קבוע לא צמוד)</h3>
            <p className="text-ink/70 mb-2">
              <strong>מהו:</strong> ריבית קבועה לכל תקופת ההלוואה. ההחזר לא ישתנה לעולם.
            </p>
            <p className="text-ink/70 mb-2"><strong>יתרון:</strong> ודאות מלאה. מגן מפני עליית ריבית. ידוע מראש.</p>
            <p className="text-ink/70 mb-5"><strong>חיסרון:</strong> ריבית גבוהה יותר מהשוק. עמלת פירעון מוקדם גבוהה כשריבית יורדת. אין הנאה מירידת ריבית.</p>

            <h3 className="text-xl font-bold text-ink mb-3">מסלול 3: קבועה צמודה למדד</h3>
            <p className="text-ink/70 mb-2">
              <strong>מהו:</strong> ריבית קבועה, אך הקרן צמודה למדד המחירים לצרכן.
            </p>
            <p className="text-ink/70 mb-2"><strong>יתרון:</strong> ריבית נמוכה יותר מקל&quot;צ. ריבית קבועה – ידוע מה משלמים (%  ריבית).</p>
            <p className="text-ink/70 mb-5"><strong>חיסרון:</strong> הקרן גדלה עם האינפלציה. בתקופת אינפלציה גבוהה (2022-2023) – יתרת החוב עלתה.</p>

            <h3 className="text-xl font-bold text-ink mb-3">מסלול 4: משתנה כל 5 שנים (צמוד מדד)</h3>
            <p className="text-ink/70 mb-2">
              <strong>מהו:</strong> ריבית מתחדשת כל 5 שנים לפי ריבית השוק. הקרן צמודה.
            </p>
            <p className="text-ink/70 mb-2"><strong>יתרון:</strong> בינוני בין קל&quot;צ לפריים. אפשרות לפירעון ביום הריענון ללא עמלה.</p>
            <p className="text-ink/70 mb-5"><strong>חיסרון:</strong> הצמדה + ריבית משתנה = כפול סיכון. עלייה חדה אפשרית.</p>

            <h3 className="text-xl font-bold text-ink mb-3">מסלול 5: משתנה לא צמוד</h3>
            <p className="text-ink/70 mb-2">
              <strong>מהו:</strong> ריבית מתחדשת כל 5 שנים, ללא הצמדה למדד.
            </p>
            <p className="text-ink/70 mb-2"><strong>יתרון:</strong> אין סיכון הצמדה. ריבית נמוכה יחסית לקל&quot;צ.</p>
            <p className="text-ink/70 mb-5"><strong>חיסרון:</strong> ריבית משתנה – חשיפה לעליות. פחות נפוץ בשוק.</p>
          ...
          <section id="mix" className="mb-14 scroll-mt-8">
            ...
            <div className="space-y-5">
              {[
                ...
                <div key={item.profile} className="bg-paper border border-ink/15 rounded-none p-5 shadow-sm">
                  <h3 className="text-lg font-bold text-ink mb-2">
                    {item.icon} {item.profile}
                  </h3>
                  <div className="bg-cream-2 rounded-none px-4 py-2 mb-2 font-mono text-ink text-sm">
                    {item.mix}
                  </div>
                  <p className="text-ink/70 text-sm">{item.why}</p>
                </div>
              ))}
            </div>

            <div className="mt-6 bg-cream-2 border border-ink/15 rounded-none p-4">
          ...
          <section id="process" className="mb-14 scroll-mt-8">
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={item.week} className="flex gap-4 bg-paper border border-ink/15 rounded-none p-4">
                  <div className="flex-shrink-0 bg-ink text-cream rounded-none px-3 py-2 text-xs font-bold text-center min-w-[80px]">
                    {item.week}
                  </div>
                  <div>
                    <h3 className="font-bold text-ink">{item.step}</h3>
                    <p className="text-ink/70 text-sm">{item.detail}</p>
                  </div>
                </div>
              ))}
          ...
          <section id="documents" className="mb-14 scroll-mt-8">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <h3 className="font-bold text-ink mb-3">מסמכי זהות</h3>
              ...
              <div>
                <h3 className="font-bold text-ink mb-3">מסמכי הכנסה (שכירים)</h3>
                <ul className="space-y-1 text-ink/70 text-sm">
              ...
              <div>
                <h3 className="font-bold text-ink mb-3">מסמכי הכנסה (עצמאיים)</h3>
                <ul className="space-y-1 text-ink/70 text-sm">
              ...
              <div>
                <h3 className="font-bold text-ink mb-3">מסמכי נכס</h3>
                <ul className="space-y-1 text-ink/70 text-sm">
              ...
              <div>
                <h3 className="font-bold text-ink mb-3">מסמכי הון עצמי</h3>
                <ul className="space-y-1 text-ink/70 text-sm">
              ...
              <div>
                <h3 className="font-bold text-ink mb-3">ביטוחים (דרישת הבנק)</h3>
                <ul className="space-y-1 text-ink/70 text-sm">
          ...
          <section id="negotiation" className="mb-14 scroll-mt-8">
            ...
            <h3 className="text-xl font-bold text-ink mb-3">טקטיקות התמקחות אפקטיביות</h3>
            <ul className="space-y-3 text-ink/70 mb-5">
          ...
          <section id="refinance" className="mb-14 scroll-mt-8">
            ...
            <h3 className="text-xl font-bold text-ink mb-3">מתי כדאי לבצע מחזור?</h3>
            ...
            <h3 className="text-xl font-bold text-ink mb-3">כיצד לחשב אם כדאי?</h3>
            <p className="text-ink/70 mb-5">
            ...
            <Link href="/blog/mortgage-refinance-when-and-how" className="text-gold underline text-sm">
          ...
          <section id="prepayment" className="mb-14 scroll-mt-8">
            ...
            <h3 className="text-xl font-bold text-ink mb-3">מתי כדאי לפרוע מוקדם?</h3>
            <ul className="space-y-2 text-ink/70 mb-5">
          ...
          <section id="grace" className="mb-14 scroll-mt-8">
            ...
            <h3 className="text-xl font-bold text-ink mb-3">גרייס (Grace Period)</h3>
            <p className="text-ink/70 mb-5">
            ...
            <h3 className="text-xl font-bold text-ink mb-3">בלון (Bullet)</h3>
            <p className="text-ink/70 mb-5">
          ...
          <section id="tools" className="mb-14 scroll-mt-8">
            ...
            <h3 className="text-lg font-bold text-ink mt-8 mb-3">פוסטים קשורים</h3>
