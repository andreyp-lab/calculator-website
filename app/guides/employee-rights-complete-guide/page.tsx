...
const employeeHowToSteps = [
  {
    ...
    text: 'ודא שקיבלת שכר מינימום (6,443.85 ₪/חודש מ-1.4.2026, 35.40 ₪/שעה), שעות נוספות (25%-50%), ודמי הבראה.',
...
const employeeFaqItems = [
  {
    ...
    answer: 'שכר המינימום מ-1.4.2026 הוא 6,443.85 ₪ לחודש (35.40 ₪/שעה ל-182 ש\' | 34.64 ₪/שעה ל-186 ש\'). מעסיק אינו יכול לשלם פחות מכך.',
  },
  {
          ...
          <section id="salary" className="mb-14 scroll-mt-8">
            ...
            <div className="overflow-x-auto mb-5">
              <table className="w-full border-collapse text-sm">
                ...
                <tbody>
                  {[
                    ['שכר מינימום חודשי', '6,443.85 ₪', 'סכום קבוע (מ-1.4.2026)'],
                    ['שכר מינימום שעתי (בסיס 182 ש\')', '35.40 ₪', 'לחלוקה לפי 182 שעות/חודש'],
                    ['שכר מינימום שעתי (בסיס 186 ש\')', '34.64 ₪', 'לעובד יומי / שעתי'],
                    ['שכר מינימום יומי (שבוע 5 ימים)', '297.40 ₪', 'שיעור יומי סטטוטורי'],
          ...
          <section id="leave" className="mb-14 scroll-mt-8">
            ...
            <div className="overflow-x-auto mb-5">
              <table className="w-full border-collapse text-sm">
                ...
                <tbody>
                  {[
                    ['1–4 שנות עבודה', '14 ימי עסקים (16 ימי ברוטו כולל ש"ק) – מינימום חוקי'],
            ...
            <div className="space-y-5">
              {[
                ...
                },
                {
                  ...
                  a: 'עד 4 שנות ותק: 14 ימי עסקים (16 ימי ברוטו). מהשנה החמישית: 14–28 ימים (מקסימום חוקי 28). הצבירה היא חוקית ואסור לאבד ימי חופשה. אם פוטרת – מגיע לך פדיון חופשה על כל הימים שלא נוצלו.',
                },
                {
